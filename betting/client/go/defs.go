...
var (
	...
	gamblerAddress = []string{"0xFFcf8FDEE72ac11b5c542428B35EEF5769C409f0",
		"0x22d491Bde2303f2f43325b2108D26f1eAbA1e32b",
		"0xE11BA2b4D45Eaed5996Cd0823791E0C93114882d",
		"0xd03ea8624C8C5987235048901fB614fDcA89b117",
		"0x95cED938F7991cd0dFcb48F0a06a40FA1aF46EBC",
		"0x3E5e9111Ae8eB78Fe1CC3bb8915d5D461F3Ef9A9"}
	oracleAddress = []string{"0x28a8746e75304c0780E011BEd21C72cD78cd535E",
		"0xACa94ef8bD5ffEE41947b4585a84BdA5a3d3DA6E",
		"0x1dF62f291b2E969fB0849d99D9Ce41e2F137006e",
	}
	gamblerPKHEX = []string{"6cbed15c793ce57650b9877cf6fa156fbef513c4e6134f022a85b1ffdd59b2a1",
	...
	oraclePKHEX = []string{"a453611d9419d0e56f499079478fd72c37b251a94bfde4d19872c44cf65386e3",
	...
	initialOutcome = [][32]byte{stringToKeccak256("1"), stringToKeccak256("2")}
)

var commands = []string{
	"Deploy", "Get Balance", "Choose Oracle", "Set Outcomes",
	"Contract Reset", "Make Bet", "Get Outcomes", "Make Decision",
	"Get Gamblers", "Get Winners", "Check Winnings", "Withdraw", 
	"Quit",
}
...
type Client struct {
	...
	bettingAddress  common.Address
	bettingInstance *contract.Betting
}

//0 for owner, 1-6 for gambler, 7-9 for oracle
var address = []string{
...
func addressMapKey(address []string, PKHEX []string) map[string]string {
...
var addMapKey=addressMapKey(address,PKHEX)